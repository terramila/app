    ...
    <footer class="footer">
        <div class="footer-left">
            <div class="footer-left__logo">
                <svg class="header-left__svg" width="34" height="34" viewBox="0 0 34 34" fill="none"
            ...
            <p class="footer-left__text">It is a long established fact that a reader will be distracted lookings.</p>
        ...
        <div class="footer-center">
            <h2 class="footer-center__header">Pages</h2>
            <a class="footer-center__item" href="#">Home</a>
            <a class="footer-center__item" href="#">Project</a>
            <a class="footer-center__item" href="#">Blog</a>
        </div>
        <div class="footer-right">
            <div class="footer-right__wrapper">
                <h2 class="footer-right__header">Contact</h2>
                <div class="footer-right__item">55 East Birchwood Ave. Brooklyn, New York 11201</div>
                <div class="footer-right__item">contact@interno.com</div>
                <div class="footer-right__item">(123) 456 - 7890</div>
            </div>
